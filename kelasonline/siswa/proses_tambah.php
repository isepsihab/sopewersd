...
// di sini juga seharusnya ada pengecekan nis sudah ada atau belom.
	// kalau sudah, sukses edit data siswa
	// kalau belom, ya registrasi dulu.
	// lebih bagusnya lagi kalo ada warning terus aa button nanti ngarahin ke halaman add nis di inventori

	//$insert = "UPDATE tbl_siswa SET id_daftar='$id_daftar', daftar = '$daftar', nama = '$nama', kelamin = '$kelamin', tempat_lahir = '$tempat_lahir', tanggal_lahir = '$tanggal_lahir', agama = '$agama', wni = '$wni', alamat = '$alamat', ayah = '$ayah', pa = '$pa', ibu = '$ibu', pi = '$pi', wali = '$wali', pw = '$pw', nohp = '$nohp', foto = '$fileName' WHERE id_daftar = '$id_daftar'";


	$insert = "INSERT INTO tbl_siswa (id_daftar, daftar, nama, kelamin, tempat_lahir, tanggal_lahir, agama, wni, alamat, ayah, pa, ibu, pi, wali, pw, nohp) VALUES ('$id_daftar', '$daftar', '$nama', '$kelamin', '$tempat_lahir', '$tanggal_lahir', '$agama', '$wni', '$alamat', '$ayah', '$pa', '$ibu', '$pi', '$wali', '$pw', '$nohp')";
	$insert_query = mysqli_query($koneksi, $insert);

	if($insert_query){
		$insert1 = "INSERT INTO tbl_inventori (id_daftar) VALUES ($id_daftar)";
		$insert_query1 = mysqli_query($koneksi, $insert1);
