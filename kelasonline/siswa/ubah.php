...
$query = mysqli_query($koneksi, "SELECT * FROM tbl_siswa WHERE id_daftar = $id_daftar");
		...
		<!-- Main Content -->
			<div id="content">
				...
				<div class="container-fluid">
					<!-- Page Heading -->
					<div class="clearfix">
						<h1 class="h3 mb-4 text-gray-800 float-left">Ubah Data Peserta Didik Baru</h1>
					...
					<div class="row">
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
									<form action="proses_ubah.php?id_daftar=<?php echo $siswa['id_daftar'] ?>" enctype="multipart/form-data" method="POST">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="number" id="id_daftar" class="form-control" placeholder="Masukan id daftar" autocomplete="off" required="required" value="<?php echo $siswa['id_daftar'] ?>">
											</div>
										</div>
											...
											<div class="input-group">
												...
												<input type="date" id="daftar" class="form-control" placeholder="Masukan Tanggal Lahir" name="daftar" autocomplete="off" required="required" value="<?php echo $siswa['daftar'] ?>">
											</di>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="nama" class="form-control" placeholder="Masukan Nama Siswa" name="nama" autocomplete="off" required="required" value="<?php echo $siswa['nama'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<select name="kelamin" id="kelamin" class="form-control">
													<option value="p/l">pilih</option>
													<option value="p" <?php echo $siswa['kelamin'] == 'p' ? 'selected' : '' ?>>Perempuan</option>
													<option value="l" <?php echo $siswa['kelamin'] == 'l' ? 'selected' : '' ?>>Laki-laki</option>
												</select>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="wni" class="form-control" placeholder="Masukan Kewarganegaraan" name="wni" autocomplete="off" required="required" value="<?php echo $siswa['wni'] ?>">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="ayah" class="form-control" placeholder="Masukan Nama Ayah" name="ayah" autocomplete="off" required="required" value="<?php echo $siswa['ayah'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="pa" class="form-control" placeholder="Masukan Pekerjaan Ayah" name="pa" autocomplete="off" required="required" value="<?php echo $siswa['pa'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="ibu" class="form-control" placeholder="Masukan Nama Ibu" name="ibu" autocomplete="off" required="required" value="<?php echo $siswa['ibu'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="pi" class="form-control" placeholder="Masukan Pekerjaan Ayah" name="pi" autocomplete="off" required="required" value="<?php echo $siswa['pi'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="wali" class="form-control" placeholder="Masukan Nama Wali Jika Ada" name="wali" autocomplete="off" required="required" value="<?php echo $siswa['wali'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="pw" class="form-control" placeholder="Masukan Pekerjaan Wali Siswa Jika Ada" name="pw" autocomplete="off" required="required" value="<?php echo $siswa['pw'] ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" id="nohp" class="form-control" placeholder="Masukan Nomor Telepon Orang Tua/Wali" name="nohp" autocomplete="off" required="required" value="<?php echo $siswa['nohp'] ?>">
											</div>
										</div>
